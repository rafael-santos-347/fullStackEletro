...
INSERT INTO `pedidos` (`id_pedidos`, `nome_cliente`, `endereco`, `telefone`, `nome_produto`, `valor_unitario`, `quantidade`) VALUES
(1, 'Vitória Emanuelly Vieira', 'Rua FV 8, numero 730, Residencial Forteville, Goiânia, GO', 38154315, 'geladeira', '5199.00', 1),
(2, 'Samuel Márcio Araújo', 'Travessa São Mateus 688, Cinturão Verde, Boa Vista, RR, ', 26787685, 'geladeira', '1499.00', 1),
(3, 'Caroline Maria Fernanda Pereira', 'Rua Conde de Porto Alegre 236, Rocha, Rio de Janeiro, RJ', 29828505, 'geladeira', '5019.00', 1),
(4, 'Rita Clarice Clara Freitas', 'Rodovia BR-381 Fernão Dias 165, Petrópolis, Betim, MG', 36984566, 'fogao', '1561.47', 1),
(5, 'Nelson Bento Luiz Souza', 'Rua das Éricas 103, Mangabeira, João Pessoa, PB', 39251413, 'fogao', '389.99', 1),
(6, 'Sarah Isis Baptista', 'Avenida Mato Grosso 109, Centro, Campo Grande, MS', 39320560, 'microondas', '494.90', 1),
(7, 'Mirella Heloise da Rocha', 'Rua Senegal 978, Lagoa Grande, Feira de Santana, BA', 29470469, 'microondas', '611.90', 1),
(8, 'Clara Jennifer Vieira', 'Rua Bacaré 685, Aleixo, Manaus, AM', 25733675, 'microondas', '494.90', 1),
(9, 'Victor Geraldo Rodrigo Costa', 'Rua Pioneiro José Pereira de Gois 554, Morada do Bosque, Cacoal, RO', 27467979, 'lava_loucas', '5019.00', 1),
(10, 'Luiz Igor Bernardo Costa', 'Alameda Dezenove 354, Aeroporto Velho, Santarém, PA', 35199899, 'lava_roupas', '5019.00', 1),
(11, 'Isabella Isabelle Corte Real', 'Rua BarÃ£o de Suassuna', 25812754, 'geladeira', '51999.00', 2);
